...
interface DataSource {
  ...
  interface JurisdictionSources {
    [key: string]: DataSource[] | Record<string, DataSource>;
  }
  ...
  const justiceJuggernautSources: JurisdictionSources = {
    "New Mexico": {
      ...
      "New Mexico Courts and Legislature": {
        name: "New Mexico Courts and Legislature",
      ...
      "Advanced_Sources": [
        ...
        {
          name: "New Mexico Judicial Branch",
          url: "https://www.nmcourts.gov/"
        },
        {
          name: "New Mexico Statutes and Court Rules",
          url: "https://laws.nmonesource.com/"
        },
        {
          name: "New Mexico State Bar Association",
          url: "https://www.nmbar.org/"
    ...
    "Advanced_Sources": [
      ...
      // Add more advanced sources here
    ],
  };
